...
(defvar *links* '(("Home" . "/") ("About Me" . "/about") ("Projects" . "/projects") ("Blog" . "/blog") ("Practice Page" . "/retro-games") ("Factorial" . "/factorial")))
...
(define-easy-handler (about :uri "/about") ()
  (standard-page
    ...
    (:p "I have a few hobbies that I partake in: hacking, reading, going to the gym, bowling, shooting, and thinking. For hacking, I normally do stuff in a Lisp dialect (Common Lisp, Scheme, or Emacs Lisp). My favorite is Common Lisp, specifically SBCL. Also related to hacking is "
        ...
        (:i "The Catcher in the Rye") ". My friends and I go bowling every Wednesday night followed by some food. I love guns too! More about that somewhere else. I'm a self proclaimed philosopher and have a handfull of ideas that I've come up with. I might put some on this site! I mostly think about metaphysics, specifically regarding the mind.")
    (:p "Last on my list of things to share to the Internet is: "
        (:a :href "https://www.gnu.org/software/emacs/" "Emacs") " is life. I wrote this entire site in Emacs and I spend most of my computer time in Emacs. I'll probably have a special page to my relationship with Emacs.")))
...
(define-easy-handler (projects :uri "/projects") ()
  (standard-page
    ...
    (:label "Current:"
            (:ol
             (:li (:a :href "http://sked.life" "SKED") "(work)")
             (:li "Strive (work)")
             (:li (:a :href "http://github.com/nuclearkev/site" "Website"))
             (:li (:a :href "http://github.com/nuclearkev/dragora-c201" "Dragora on C201"))
             (:li "Converting my self into a Lisp machine")))
    (:label "Past:"
            (:ol
             (:li (:a :href "http://github.com/nuclearkev/iir-hardware" "IIR in Hardware"))
             (:li (:a :href "http://github.com/nuclearkev/jul-mode" "jul-mode") "(returning soon)")
             (:li "Converting my self into a human")))
    (:p "More stuff to come!")))

(define-easy-handler (blog :uri "/blog") ()
  (standard-page
      (:title "Blog")
    (:p "This will be a place where I'll post fun stuff that I feel like talking about.")))
